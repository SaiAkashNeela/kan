...
const Testimonials = () => {
  ...
  const testimonials: Testimonial[] = [
    ...
    },
    {
      ...
      text: (
        <>
          The interesting thing about signing into {appName} for the first time is
          ...
          <br />
          <br />
          At its core, {appName} gives you a super-minimalist and frills-free
    ...
    <>
      <div className="flex flex-col items-center justify-center px-4 pb-24">
        ...
        <p className="text-md lg:text-md mt-3 max-w-[500px] text-center text-light-950 dark:text-dark-900">
          {t`See what our users are saying about ${appName}`}
        </p>
