...
This guide introduces how to self-host Kan. It starts with the minimal Docker Compose setup (web + managed PostgreSQL) and points you to optional features like email and S3-based file storage.
...
<CardGroup cols={2}>
  ...
  <Card title="PostgreSQL" icon="database" color="#65a30d" horizontal>
    Primary database for Kan data, provided by your managed PostgreSQL service.
  </Card>
</CardGroup>
...
<Steps>
  <Step title="Create a docker-compose.yml">
    ...
    services:
      web:
        ...
        environment:
          ...
          POSTGRES_URL: postgresql://kan:your_postgres_password@managed-db.example.com:5432/kan_db
    ...
    <Tip>
      The example above is intentionally minimal. The repository provides a more feature-complete compose file at [docker-compose.yml](https://github.com/kanbn/kan/blob/main/docker-compose.yml) if you want environment-based configuration, OAuth, S3, and more. It no longer starts a local PostgreSQL container.
    </Tip>
