...
<CardGroup cols={2}>
  ...
  <Card title="PostgreSQL" icon="database" color="#65a30d" horizontal>
    PostgreSQL database for Kan, provided externally.
  </Card>
</CardGroup>
...
- Open local ports: 3000 (Kan), 9000/9001 (MinIO)
...
<Steps>
  <Step title="Set environment variables">
    ...
    POSTGRES_URL=postgresql://kan:<password>@managed-db.example.com:5432/kan_db
  ...
  <Step title="Create or review Docker Compose files">
    ...
    Start with the minimal setup (web + managed postgres + minio) and ensure environment variables are passed to the web service.
    ...
    <Note type="info">
      ...
      <ul>
        <li>
          <code>POSTGRES_URL=postgresql://kan:changeme@managed-db.example.com:5432/kan_db</code>
        </li>
        <li>
